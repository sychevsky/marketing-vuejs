...
import { helpers, className, selector } from './helpers'
...
export default {
  ...
  methods: {
    ...
    toggle () {
      ...
      let $parentPlan = helpers.getAncestor($currentEl, selector.productPlan);
      let $isParentPlanActive;

      if($parentPlan !== null) {
        $isParentPlanActive = $parentPlan.classList.contains(className.active);
      }

      // if(!$isParentPlanActive) {
      //   this.isOpen = false;
      //   return false
      // }
